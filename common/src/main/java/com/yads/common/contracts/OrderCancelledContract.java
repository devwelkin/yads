 ...
 *
 * CRITICAL: This contract includes the 'oldStatus' field to prevent GHOST INVENTORY.
 *
 * Stock should ONLY be restored if the order was previously in PREPARING or ON_THE_WAY status.
 * If the order was PENDING, stock was never deducted, so restoration would create phantom stock.
 *
 * Example:
